...
export const strings = {
  en: {
    ...
    firstLanding: `Learn to code with mentors and friends in our open source community.`,
    ...
    trashTalkPSA:
      "Optional: Trash talk. Send a motivating, or withering, message to your competition.",
    ...
    suggestResources:
      "Click here to suggest a resource into our community knowledge base",
    ...
    meditationSummary:
      "Right after lunch, around 1 or 2, meditate to avoid hitting the performance trough.",
    ...
    consistencySummary:
      "Wake up at the same time each day, and check-in with the Pareto app within 5 minutes.",
  ...
  es: {
    ...
    checkEmail:
      "Por favor revise su correo electrónico para obtener el código.",
    ...
    homeFirst:
      "Aquí puedes editar tu nombre, foto de perfil y biografía que está disponible públicamente.",
    homeThird:
    ...
    arenaThird:
      "A continuación, encontrará una lista de las misiones que ya ha completado durante el día.",
    arenaFourth:
  ...
  lg: {
    ...
    // landing copy
    firstLanding:
      "Yiiga okuziimba pulogulaamu ku byuma bikalimagezi ngoli n'abemikwano wamu n'abasomesa.",
    secondLanding:
    ...
    noIdeasYet:
      "Tonafuuna kilowoozo kya pulojekiti? Nyiga akapeesa kano okugatako ekilowozo kyo ",
    noProjectsYet:
      "Tolina pulojekiti engenda maaso? Nyiiga kano akapeesa okugato pulojekiti",
    ...
    flashcards:
      "Mataatu 52,okuyiga eby'ekinzo bya Javascript methods ne API's.",
    stickers:
      "Workflow stickers ezi nakuyamba o'kujukira terminal commands ng'okozsa Git,AWS Amplify ne Bash",
    workbooks:
    ...
    exerciseSummary:
      "mu ssawa emu ng'ozukuse, kola duyilo okumala edikkika 20 oba 30",
    meditation: "Meditation",
    meditationSummary:
    ...
    consistencySummary:
      "zzukuka esaawa zzezimu buli lunaku, okeebele Pareto app yo mu dakiika taano ng'ozuukuse",
    deepWork: "Ssawa satu ezokola ng'atodililiza",
    deepWorkSummary:
      "Clock in, and clock out.Teli kwewwala kkola n'akutekamu manyi mubulikimu ky'osalawo okukola",
    eveningCreativity: "Evening Creativity",
    creativitySummary:
    ...
    secondFrogSummary:
      "bwomala okuly'ekikere,Waliyo ekintu eky'okubili eky'esonga,waakiikoze?",
  },
  ...
  ngpg: {
    ...
    confirm: "Confirm Password",
    confirmationCode: "Confirmation Code",
    checkEmail: "Abeg check your email for the code.",
    resetPassword: "Reset Password",

    lowerArena: "The Arena",

    // landing copy, this is what is visible on the first page.
    firstLanding: `sabi to code com become sabinus, with your padi dem and oga wey sabi wella for our community with beta follow up.`,
    secondLanding: `Structure, accountability and friendly competition will keep you motivated while you train for a new
		career & build the habits necessary to achieve great things in life.`,
    thirdLanding: `Our mission is to provide the 20% of software that will give you 80% of the benefits that modern technology gives you.`,
    ...
    library: "Library of Context",
    verify: "Verify",
    nowVerifying: "Checking if na correct..",
    sending: "Sending...",
    sendConfirmation: "Send Confirmation",

    startSprint: "Start a Sprint",
    sprintDescription:
      "Sprints na 5-Day events where you go measure your ability to perform for di highest level. Currently, sprints must start on a Monday and Finish on a Friday.",
    create: "Create",

    pageNoExist: "Sorry, this page no dey!",
    returnToHome: "here na to go back to di home page.",
    markAsComplete: "Submit Work",
    reviewWork: "Review Work",
    seeTheProof: "Press to See Proof",
    ...
    attachment: "Attachment for Proof",
    messaging: "Pareto League Chat",
    enterMessage: "Type your message for here",
    achievements: "Achievements",
    points: "Points",
    viewExperience: "View Progress",
    resources: "Resources",
    openLink: "Open Link for New Tab",
    confirmation: "Confirmation",
    rank: "Rank",
    name: "Name",
    score: "Score",
    ...
    goodWork: "Good Work",
    createTemplate: "Create Sprint Template",
    editTemplateName: "Edit di Template Name",
    startNewSprint: "Start New Sprint",
    editName: "Edit Name",
    changePicture: "Change Profile Picture",
    cancel: "Cancel",
    ...
    bio: "Public Bio",
    school: "School",
    pleaseChooseAnOption: "Abeg Choose an Option",
    projects: "Projects",
    projectName: "Project Name",
    projectIdeas: "Project Notes & Ideas",
    ...
    save: "Save",
    githubRepository: "GitHub Repository",
    ifNoSprints: "Start small work by clicking on di link wey dey for up!",
    viewSprint: "View Sprint",
    myMentees: "My Guys wey dey learn work",
    options: "Options",
    morning: "Morning",
    workday: "Workday",
    evening: "Evening",
    ...
    selectPlayers: "Choose Your Competitors",
    trashTalkPSA:
      "Optional: Nonsense talk. Send ginger, or intimidating, message to your competition.",
    viewProof: "View Proof",
    noProof: "No proof was submitted",
    arenaNav: "Arena",
    learnNav: "Learn",
    ...
    eventType: "Event Type",
    dashboard: "The Arena",
    landingText: "Wetin people dey talk",
    fullStackDev: "Full Stack Dev",
    localCommunities: "Local Communities & Meetups Dem",
    suggestResources:
      "Click here to suggest beta things for we community knowledge base",
    incubators: "Start-up incubators & Venture Capital Investors Dem",
    startups: "Interesting Start-Ups and Hiring Companies Dem",
    localNews: "Local News & Industry Trends Dem",
    fullName: "Full Name",
    streetAddress: "Street Address",
    creditCardInfo: "Credit Card Info",
    myMentors: "My Oga dem wey sabi well well",
    apprenticeship: "Full-Stack Apprenticeship",
    myCareer: "MyCareer",
  ...
  hi: {
    ...
    login: "साइन इन करें",
    logout: "लॉग आउट",
    loggingIn: "साइनइन कर रहे है...",
    signup: "साइन अप करें",
    signingUp: "रजिस्टर कर रहे है...",
    password: "पासवर्ड",
    oldPassword: "पुराना पासवर्ड",
    newPassword: "नया पासवर्ड",
    confirm: "पासवर्ड कंफर्म कीजिये",
    confirmationCode: "कन्फर्मेशन कोड",
    checkEmail: "कृपया कोड के लिए अपना ईमेल देखें.",
    resetPassword: "पासवर्ड रीसेट",

    lowerArena: "एरिना",

    // landing copy, this is what is visible on the first page.
    firstLanding: `आपको बेहतर बनाए रखने के लिए हमारे ओपन-सोर्स समुदाय में दोस्तों और उपदेशक के साथ सामाजिक रूप से कोड करना और एक बेहतर व्यक्ति बनना सीखें.`,
    ...
    firstName: "पहला नाम",
    lastName: "आखिरी नाम",
    github: "गिटहब यूजरनेम",
    city: "शहर",
    country: "देश",
    phone: "फ़ोन",

    // interface
    createNewUser: "नया यूजर बनाएं",
    userDirectory: "यूजर डायरेक्टरी",
    matchUsers: "मैच यूजर",
    mentorshipList: "मेंटरशिप और स्प्रिंट टेम्प्लेट देखें",
    sandbox: "सैंडबॉक्स",
    promoteUser: "यूजर को अपग्रेड करें",

    basicTraining: "फुल-स्टैक JS",
    technicalTraining: "डेव ऑनबोर्डिंग",
    findingWork: "काम ढूँढना",
    cityByCity: "शहर गाइड",
    training: "ऑनबोर्डिंग",
    product: "अपना प्रोडक्ट बनाएं",
    interviewing: "टेक इंटरव्यूज",
    arena: "एरिना",
    arenaSprints: "एरिना स्प्रिंट",
    mentorship: "मेंटरशिप",
    achievement: "अचीवमेंट",
    viewDailyAchievements: "",
    neuroProfile: "न्यूरो एथलेटिक प्रोफाइल",
    completionPercentage: "कम्पलीशन परसेंटेज",
    leaderboard: "लीडरबोर्ड",
    position: "रैंक",
    library: "लाइब्रेरी  ऑफ़  कॉन्टेक्स्ट",
    verify: "वेरीफाई",
    nowVerifying: "अब वेरीफाई कर रहे हैं..",
    sending: "भेज रहे है...",
    sendConfirmation: "कन्फर्मेशन भेजें",

    startSprint: "स्प्रिंट शुरू करें",
    sprintDescription:
      "स्प्रिंट 5-दिवसीय इवेंट हैं जहां आप उच्चतम स्तर पर प्रदर्शन करने की अपनी क्षमता को मापते हैं. वर्तमान में, स्प्रिंट सोमवार को शुरू होना चाहिए और शुक्रवार को समाप्त होना चाहिए.",
    create: "बनाएं",

    pageNoExist: "क्षमा करें, यह पेज मौजूद नहीं है!",
    returnToHome: "होम पेज पर वापस जाने के लिए यहां.",
    markAsComplete: "काम सबमिट करें",
    reviewWork: "काम का रिव्यु करे",
    seeTheProof: "प्रूफ देखने के लिए दबाएं",

    experienceModule: "एक्सपीरियंस मॉड्यूल",
    coachDashboard: "माईकोच एथलीट",
    pickSprint: "स्प्रिंट सेलेक्ट करें",
    starts: "शुरू होगा",
    finishes: "खत्म होगा",
    close: "बंद",
    delete: "डिलीट",
    weeklyPerformanceAnalytics: "वीकली  परफॉरमेंस  एनालिटिक्स",
    back: "पीछे",
    next: "आगे",
    submitProof: "सबूत जमा करें",
    notesForCoach: "कोच के लिए नोट्स",
    coachesNotes: "कोच के नोट्स",
    submitLink: "लिंक (GitHub, वगैरह)",
    attachment: "सबूत",
    messaging: "परेटो लीग चैट",
    enterMessage: "अपना संदेश यहां लिखे",
    achievements: "सफलता",
    points: "अंक",
    viewExperience: "प्रगति देखें",
    resources: "साधन",
    openLink: "एक नए टैब में लिंक खोलें",
    ...
    creating: "बना रहे है...",
    reviewFor: "रिव्यु करे",
    description: "वर्णन",
    clickToDownload: "डाउनलोड करने के लिए यहां क्लिक करें",
    requestRevisions: "रीविज़न के लिए रिक्वेस्ट करे",
    confirmAchievement: "अचीवमेंट को कन्फर्म करे",

    dailyPoints: "दैनिक अंक",
    daily: "रोजाना",
    weekly: "साप्ताहिक",
    weeklyPoints: "साप्ताहिक अंक",
    upcomingMission: "दैनिक अचीवमेंट",
    finishedMissions: "संपूर्ण अचीवमेंट",
    goodWork: "अच्छा कार्य",
    createTemplate: "स्प्रिंट टेम्पलेट बनाएं",
    editTemplateName: "टेम्पलेट का नाम बदले",
    startNewSprint: "नया स्प्रिंट शुरू करें",
    editName: "नाम बदले",
    ...
    bio: "सार्वजनिक बायो",
    school: "स्कूल",
    pleaseChooseAnOption: "एक विकल्प चुने",
    projects: "प्रोजेक्ट्स",
    projectName: "प्रोजेक्ट्स का नाम",
    ...
    ifNoSprints: "ऊपर दिए गए लिंक पर क्लिक करके एक नया स्प्रिंट शुरू करें!",
    viewSprint: "स्प्रिंट देखें",
    myMentees: "मेरे मेंटिस",
    options: "विकल्प",
    morning: "सुबह",
    workday: "कार्यदिवस",
    evening: "शाम",
    sabbath: "विश्राम का समय",
    weekend: "छुट्टी का दिन",
    ...
    arenaNav: "एरिना",
    learnNav: "सीखें",
    libraryNav: "लाइब्रेरी",
    chatNav: "चैट",
    profileNav: "प्रोफ़ाइल",
    chatroom: "लीग चैट",
    createEvent: "इवेंट बनाएँ",
    eventName: "इवेंट का नाम",
    eventDescription: "इवेंट का वर्णन",
    eventLink: "इवेंट लिंक",
    eventDate: "इवेंट तारीख",
    eventStart: "इवेंट शुरू",
    eventEnd: "इवेंट ख़त्म",
    eventType: "इवेंट टाइप",
    dashboard: "एरिना",
    landingText: "लोग क्या कह रहे हैं",
    fullStackDev: "फुल स्टैक डेव",
    localCommunities: "लोकल समुदाय और बैठकें",
    suggestResources:
      "हमारे सामुदायिक में संसाधन का सुझाव देने के लिए यहां क्लिक करें",
    incubators: "स्टार्ट-अप इनक्यूबेटर और वेंचर कैपिटल निवेशक",
    startups: "दिलचस्प स्टार्ट-अप और हायरिंग कंपनियां",
    localNews: "लोकल समाचार और उद्योग",
    fullName: "पूरा नाम",
    streetAddress: "गली का पता",
    creditCardInfo: "क्रेडिट कार्ड की जानकारी",
    myMentors: "मेरे मेंटर्स",
    apprenticeship: "फुल-स्टैक अप्रेंटिसशिप",
    myCareer: "मेरा करियर",
